 ...
 */
final class Version20260211211431 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE achat (id INT AUTO_INCREMENT NOT NULL, nom_article VARCHAR(255) NOT NULL, est_achete TINYINT NOT NULL, created_at DATETIME NOT NULL, categorie_id INT DEFAULT NULL, family_id INT DEFAULT NULL, created_by_id VARCHAR(36) DEFAULT NULL, INDEX IDX_26A98456BCF5E72D (categorie_id), INDEX IDX_26A98456C35E566A (family_id), INDEX IDX_26A98456B03A8386 (created_by_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE audit_trail (id INT AUTO_INCREMENT NOT NULL, action VARCHAR(255) DEFAULT NULL, payload JSON DEFAULT NULL, user_agent LONGTEXT DEFAULT NULL, ip_address VARCHAR(64) DEFAULT NULL, channel VARCHAR(32) DEFAULT NULL, created_at DATETIME NOT NULL, user_id VARCHAR(36) DEFAULT NULL, family_id INT DEFAULT NULL, INDEX IDX_B523E178A76ED395 (user_id), INDEX IDX_B523E178C35E566A (family_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE categorie_achat (id INT AUTO_INCREMENT NOT NULL, nom_categorie VARCHAR(255) NOT NULL, family_id INT DEFAULT NULL, INDEX IDX_D3D16986C35E566A (family_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE rappel (id INT AUTO_INCREMENT NOT NULL, offset_minutes INT NOT NULL, canal VARCHAR(255) NOT NULL, actif TINYINT DEFAULT NULL, est_lu TINYINT NOT NULL, scheduled_at DATETIME NOT NULL, read_at DATETIME DEFAULT NULL, evenement_id INT NOT NULL, user_id VARCHAR(36) DEFAULT NULL, family_id INT DEFAULT NULL, INDEX IDX_303A29C9FD02F13 (evenement_id), INDEX IDX_303A29C9A76ED395 (user_id), INDEX IDX_303A29C9C35E566A (family_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE task (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, difficulty VARCHAR(50) NOT NULL, recurrence VARCHAR(50) NOT NULL, created_at DATETIME NOT NULL, is_active TINYINT NOT NULL, family_id INT DEFAULT NULL, created_by_id VARCHAR(36) NOT NULL, INDEX IDX_527EDB25C35E566A (family_id), INDEX IDX_527EDB25B03A8386 (created_by_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE task_assignment (id INT AUTO_INCREMENT NOT NULL, assigned_at DATETIME NOT NULL, due_date DATETIME DEFAULT NULL, refused_at DATETIME DEFAULT NULL, status VARCHAR(50) NOT NULL, task_id INT NOT NULL, user_id VARCHAR(36) NOT NULL, family_id INT NOT NULL, INDEX IDX_2CD60F158DB60186 (task_id), INDEX IDX_2CD60F15A76ED395 (user_id), INDEX IDX_2CD60F15C35E566A (family_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE task_completion (id INT AUTO_INCREMENT NOT NULL, completed_at DATETIME NOT NULL, proof VARCHAR(255) NOT NULL, is_validated TINYINT DEFAULT NULL, validated_at DATETIME DEFAULT NULL, parent_comment LONGTEXT DEFAULT NULL, task_id INT NOT NULL, user_id VARCHAR(36) NOT NULL, validated_by_id VARCHAR(36) DEFAULT NULL, INDEX IDX_24C57CD18DB60186 (task_id), INDEX IDX_24C57CD1A76ED395 (user_id), INDEX IDX_24C57CD1C69DE5E5 (validated_by_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE type_evenement (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, couleur VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, date_creation DATETIME NOT NULL, family_id INT DEFAULT NULL, INDEX IDX_BFE0290EC35E566A (family_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE user (id VARCHAR(36) NOT NULL, email VARCHAR(180) NOT NULL, username VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, birth_date DATE NOT NULL, avatar_path VARCHAR(255) DEFAULT NULL, locale VARCHAR(255) NOT NULL, time_zone VARCHAR(255) DEFAULT NULL, preferences JSON DEFAULT NULL, status VARCHAR(255) NOT NULL, system_role VARCHAR(255) NOT NULL, family_role VARCHAR(255) NOT NULL, email_verification_token VARCHAR(64) DEFAULT NULL, email_verification_requested_at DATETIME DEFAULT NULL, email_verified_at DATETIME DEFAULT NULL, reset_token VARCHAR(255) DEFAULT NULL, reset_expires_at DATETIME DEFAULT NULL, last_login DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, family_id INT DEFAULT NULL, INDEX IDX_8D93D649C35E566A (family_id), UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), UNIQUE INDEX UNIQ_IDENTIFIER_USERNAME (username), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
