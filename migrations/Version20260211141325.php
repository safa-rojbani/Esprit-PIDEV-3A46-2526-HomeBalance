 ...
 */
final class Version20260211141325 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE account_notification (id INT AUTO_INCREMENT NOT NULL, user_id VARCHAR(36) NOT NULL, notification_key VARCHAR(64) NOT NULL, channel VARCHAR(32) NOT NULL, status VARCHAR(32) NOT NULL, payload JSON DEFAULT NULL, attempts INT NOT NULL, last_error LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', sent_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_268C608CA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE audit_trail (id INT AUTO_INCREMENT NOT NULL, user_id VARCHAR(36) DEFAULT NULL, family_id INT DEFAULT NULL, action VARCHAR(255) DEFAULT NULL, payload JSON DEFAULT NULL, user_agent LONGTEXT DEFAULT NULL, ip_address VARCHAR(64) DEFAULT NULL, channel VARCHAR(32) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_B523E178A76ED395 (user_id), INDEX IDX_B523E178C35E566A (family_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE rappel (id INT AUTO_INCREMENT NOT NULL, evenement_id INT NOT NULL, user_id VARCHAR(36) DEFAULT NULL, family_id INT DEFAULT NULL, offset_minutes INT NOT NULL, canal VARCHAR(255) NOT NULL, actif TINYINT(1) DEFAULT NULL, est_lu TINYINT(1) NOT NULL, INDEX IDX_303A29C9FD02F13 (evenement_id), INDEX IDX_303A29C9A76ED395 (user_id), INDEX IDX_303A29C9C35E566A (family_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
