 ...
 */
final class Version20260211230333 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE categorie_achat (id INT AUTO_INCREMENT NOT NULL, family_id INT DEFAULT NULL, nom_categorie VARCHAR(255) NOT NULL, INDEX IDX_D3D16986C35E566A (family_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE gallery (id INT AUTO_INCREMENT NOT NULL, family_id INT DEFAULT NULL, created_by_id VARCHAR(36) NOT NULL, default_gallery_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, etat VARCHAR(255) NOT NULL, created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', deleted_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_472B783AC35E566A (family_id), INDEX IDX_472B783AB03A8386 (created_by_id), INDEX IDX_472B783A4CC4FBEC (default_gallery_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE message (id INT AUTO_INCREMENT NOT NULL, conversation_id INT NOT NULL, sender_id VARCHAR(36) NOT NULL, content LONGTEXT NOT NULL, attachment_url VARCHAR(255) DEFAULT NULL, sent_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', is_read TINYINT(1) NOT NULL, INDEX IDX_B6BD307F9AC0396 (conversation_id), INDEX IDX_B6BD307FF624B39D (sender_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE point_rule (id INT AUTO_INCREMENT NOT NULL, task_id INT NOT NULL, points INT NOT NULL, valid_from DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', valid_to DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_CF584BAE8DB60186 (task_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE rappel (id INT AUTO_INCREMENT NOT NULL, evenement_id INT NOT NULL, user_id VARCHAR(36) DEFAULT NULL, family_id INT DEFAULT NULL, offset_minutes INT NOT NULL, canal VARCHAR(255) NOT NULL, actif TINYINT(1) DEFAULT NULL, est_lu TINYINT(1) NOT NULL, scheduled_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', read_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_303A29C9FD02F13 (evenement_id), INDEX IDX_303A29C9A76ED395 (user_id), INDEX IDX_303A29C9C35E566A (family_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE revenu (id INT AUTO_INCREMENT NOT NULL, family_id INT DEFAULT NULL, created_by_id VARCHAR(36) DEFAULT NULL, type_revenu VARCHAR(255) NOT NULL, montant NUMERIC(10, 2) NOT NULL, montant_total NUMERIC(10, 2) DEFAULT NULL, date_revenu DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_7DA3C045C35E566A (family_id), INDEX IDX_7DA3C045B03A8386 (created_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE score (id INT AUTO_INCREMENT NOT NULL, user_id VARCHAR(36) NOT NULL, family_id INT NOT NULL, total_points INT NOT NULL, last_updated DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_32993751A76ED395 (user_id), INDEX IDX_32993751C35E566A (family_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE score_history (id INT AUTO_INCREMENT NOT NULL, score_id INT NOT NULL, task_id INT NOT NULL, points INT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_463255DF12EB0A51 (score_id), INDEX IDX_463255DF8DB60186 (task_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE type_evenement (id INT AUTO_INCREMENT NOT NULL, family_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, couleur VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, date_creation DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_BFE0290EC35E566A (family_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
